                            ...
                            <?php else: ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0);" onclick="if(confirm('Supprimer ce plat du menu ?')) { window.location.href='delete_menu.php?id=<?php echo urlencode($pl['idplat']); ?>'; }" class="btn-delete">Supprimer</a>
                                    </td>
                                </tr>
                            <?php endif; ?>
